...
[![Windows Builds](https://github.com/coin-or/CHiPPS-BLIS/actions/workflows/windows-ci.yml/badge.svg?branch=releases/0.95.0)](https://github.com/coin-or/CHiPPS-BLIS/actions/workflows/windows-ci.yml?query=branch%3Areleases/0.95.0)

[![Linux and MacOS Builds](https://github.com/coin-or/CHiPPS-BLIS/actions/workflows/linux-ci.yml/badge.svg?branch=releases/0.95.0)](https://github.com/coin-or/CHiPPS-BLIS/actions/workflows/linux-ci.yml?query=branch%3Areleases/0.95.0)
...
directory will be `./build/CHiPPS-BLIS/0.95.0` by default. The doxygen documentation main file
